...
**Condition :**
- Tant qu'il reste un point d'ancrage sur l'arche d'accueil
...
**Le gestionnaire peut changer dans le temps.**

**Raisons de perte de gestion :**
- Joueur ne permet pas l'entretien
- Ne permet pas le bon fonctionnement
- Ã¢" "ê Perd ses droits de possession
...
## ğŸ?¯Â§Â© Les 13 Modules Spatiaux
...
- Transformation matiÃ¨res premiÃ¨res Ã¢" "ê produits intermÃ©diaires/finaux

**Exemples :**
- Minerai Ã¢" "ê MÃ©tal
- MÃ©tal Ã¢" "ê Composants
- Composants Ã¢" "ê Produits finis
...
### 12. Module Revente de Vaisseaux

**Fonction :** Commerce de vaisseaux

**Services :**
- Achat vaisseaux (occasion)
...
### 4. Services Installables

**Exemples :**
- Achat-vente explorations
- Bourse locale
- Banque
- Assurances
- Douanes
...
**Population :** Importante (marchands, visiteurs)
...
## Ã¢Å¡â„¢Ã¯Â¸Â? Contraintes et Gestion
